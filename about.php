...
<!-- about -->
  ...
  <div>
    <div align=center	> <img src="images/1.png" alt="Avatar">
      
      <p>Student</p>
    </div>
    <div><br><br>
	<p align=center style="font-size:30px;">We self taught programmer with over 1 years experience with various languages including html,C etc.</p>
				...
				<div class="container">
					...
					<div class="statistics-grids">
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller">01</div>
							<h5>Active users</h5>
						</div>
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller">00</div>
							<h5>Partners</h5>
						</div>
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller">00</div>
